function sojaeji(page, sido, gugun, dong) {// page:함수를 호출한 페이지
	var 
	addr ={	
	'시도' : ['서울','부산','대구','인천','광주','대전','울산','강원','경기','경남','경북','전남','전북','제주','충남','충북','세종'],
	...
	'세종' : ['세종특별자치시'],
	'서울->강남구' : ['개포1동','개포2동','개포4동','개포동','논현1동','논현2동','논현동','대치1동','대치2동','대치4동','대치동','도곡1동','도곡2동','도곡동','삼성1동','삼성2동','삼성동','세곡동','수서동','신사동','압구정동','역삼1동','역삼2동','역삼동','율현동','일원1동','일원2동','일원본동','일원동','자곡동','청담동'],
	'서울->강동구' : ['강일동','고덕1동','고덕2동','고덕동','길동','둔촌1동','둔촌2동','둔촌동','명일1동','명일2동','명일동','상일동','성내1동','성내2동','성내3동','성내동','암사1동','암사2동','암사3동','암사동','천호1동','천호2동','천호3동','천호동'],
	'서울->강북구' : ['미아동','번1동','번2동','번3동','번동','삼각산동','삼양동','송중동','송천동','수유1동','수유2동','수유3동','수유동','우이동','인수동','서울강북우체국사서함'],
	'서울->강서구' : ['가양1동','가양2동','가양3동','가양동','개화동','공항동','과해동','내발산동','등촌1동','등촌2동','등촌3동','등촌동','마곡동','방화1동','방화2동','방화3동','방화동','염창동','오곡동','오쇠동','외발산동','우장산동','화곡1동','화곡2동','화곡3동','화곡4동','화곡6동','화곡8동','화곡본동','화곡동'],
	'서울->관악구' : ['낙성대동','난곡동','난향동','남현동','대학동','미성동','보라매동','봉천동','삼성동','서림동','서원동','성현동','신림동','신사동','신원동','은천동','인헌동','조원동','중앙동','청룡동','청림동','행운동'],
	'서울->광진구' : ['광장동','구의1동','구의2동','구의3동','구의동','군자동','능동','자양1동','자양2동','자양3동','자양4동','자양동','중곡1동','중곡2동','중곡3동','중곡4동','중곡동','화양동','서울광진우체국사서함'],
	'서울->구로구' : ['가리봉동','개봉1동','개봉2동','개봉3동','개봉동','고척1동','고척2동','고척동','구로1동','구로2동','구로3동','구로4동','구로5동','구로동','궁동','신도림동','오류1동','오류2동','오류동','온수동','천왕동','항동'],
	'서울->금천구' : ['가산동','독산1동','독산2동','독산3동','독산4동','독산동','시흥1동','시흥2동','시흥3동','시흥4동','시흥5동','시흥동','서울금천우체국사서함'],
	'서울->노원구' : ['공릉1.3동','공릉2동','공릉동','상계1동','상계2동','상계3.4동','상계5동','상계6.7동','상계8동','상계9동','상계10동','상계동','월계1동','월계2동','월계3동','월계동','중계1동','중계2.3동','중계4동','중계본동','중계동','하계1동','하계2동','하계동'],
	...
	this.sido.onchange = function() { 		
		...
		zone1 = this.value;
		if(page=="map") selZone(zone1);
	};
	if(dong!=null){
		this.gugun.onchange = function() {
			makeOption(parent.sido.value + '->' + this.value, parent.dong);
			zone2 = zone1+' '+this.value;
			if(page=="map") selZone(zone2);
		};
		this.dong.onchange = function() {
			zone3 = zone2+' '+this.value;
			selZone(zone3);
		};
	}
...
//selectbox로 선택한 지역의 위치검색, 병원 데이터 파싱 함수
function selZone(zone){
	// 주소-좌표 변환 객체를 생성합니다
	var geocoder = new daum.maps.services.Geocoder();
	// 주소로 좌표를 검색합니다
	geocoder.addressSearch(zone, function(result, status) {
		...
		if (status === daum.maps.services.Status.OK) {
			...
			hideMarkers();//이전마커 숨기기
			centerMarker.setMap(null);//이전 중심마커 숨기기
			clat = coords.jb;//현재의 위도,경도를 저장해놓기
			clon = coords.ib;
			...
			var notpoint=''; //좌표->주소 //주소를 저장하는 변수
			geocoder.coord2RegionCode(clon,clat ,function(result){
				for (var i = 0; i < result.length; i++) {
		         ...
		         if(realTime==false){//실시간 off일때
		            //ajax로 현재위치 위도,경도를 보내고 결과데이터를 받아서 마커표시
		            $.get( "move", {
		               'lat':coords.jb, 
		               'lon':coords.ib, 
		               'notpoint': notpoint,
