...
<body>
   ...
   $(function(){
	...
	<div>
		...
		<div id="basic">
			<div id="img"></div>
	  		<div><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> 주소 : ${addr }</div> 
	  		<div><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span> 전화번호 : ${tel }</div> 
	  		<div id="homepage"></div> 
			<div id="navi"></div>
		</div>
   ...
   <script type="text/javascript">
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=177af53ddad8864dab8498322bdb3f8a"></script>
	<script>    
	...
	<script type="text/javascript">
		...
		if(RTjson){
			...
			var homepage = RTjson.dutyUrl;	//홈페이지
			var img = RTjson.dutyImg;		//기관이미지
			...
			if(homepage){
				$('#homepage').append('<span class="glyphicon glyphicon-home" aria-hidden="true"></span> 홈페이지 : <a href="'+homepage+'">'+homepage+'</a>');
			}
			if(img){
				$('#img').append(img);
			}
